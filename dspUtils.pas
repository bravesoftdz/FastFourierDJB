...
uses
  ...
  function GetWindowingValue(const Value : Float; Index, FFTSize : integer; Window : TWindowMode): Float;
  ...
  function Clip_32F(Value : Float) : Float;

  { The Result of FFTSum is the same as when doing sqrt(sqr(real) + sqr(imag)). }
  function FFTSum(real, imag : Float) : Float;
